...
public interface WikiService {
     ...
     */
    PaginationResponseDTO<WikiResponseDTO> getMyWikis(String statusFilter, Long tagIdFilter, PaginationRequestDTO paginationRequestDTO);
     ...
     * @return A {@link PaginationResponseDTO} containing a paginated list of {@link WikiSubmissionResponseDTO}s.
     */
    PaginationResponseDTO<WikiSubmissionResponseDTO> getPendingWikiSubmissionsForReview(PaginationRequestDTO paginationRequestDTO);
     ...
     */
    WikiSubmissionResponseDTO reviewWikiSubmission(Long submissionId, SubmissionReviewRequestDTO reviewDTO);
